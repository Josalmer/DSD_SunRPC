...
static mresponse *
_restamatrix_1 (restamatrix_1_argument *argp, struct svc_req *rqstp)
{
	return (restamatrix_1_svc(argp->arg1, argp->arg2, rqstp));
}
...
calcprog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		...
		restamatrix_1_argument restamatrix_1_arg;
	} argument;
	char *result;
	...
	case RESTAMATRIX:
		_xdr_argument = (xdrproc_t) xdr_restamatrix_1_argument;
		_xdr_result = (xdrproc_t) xdr_mresponse;
		local = (char *(*)(char *, struct svc_req *)) _restamatrix_1;
		break;
