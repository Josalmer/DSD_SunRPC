...
# gcc calculadora_clnt.c calculadora_client.c calculadora_xdr.c -o client -lnsl
# gcc calculadora_svc.c calculadora_server.c calculadora_xdr.c -o server -lnsl -lm
# Parameters
